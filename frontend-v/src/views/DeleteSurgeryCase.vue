...
<style scoped>
/* ✅ เพิ่ม Material Icons สำหรับสัญลักษณ์ใน Drawer */
...
/* ปรับ Header ของ Drawer ให้สูงเท่ากับ Navbar หลัก */
.drawer-header {
    background-color: #6a92d4;
    height: 80px;
    /* ปรับลดจาก 130px ลงมาเหลือ 80px ให้เท่ากับ top-nav */
    display: flex;
    align-items: center;
    /* เปลี่ยนจาก flex-end เป็น center เพื่อให้ไอคอนอยู่กลางแนวตั้ง */
    padding: 0 25px;
    /* ระยะห่างด้านซ้ายให้เท่ากับ top-nav */
    flex-shrink: 0;
}
...
.drawer-license {
    font-size: 1.4rem;
    /* ปรับขนาดให้เท่ากับ Navbar หลัก */
    line-height: 1.2;
}
...
.drawer-day {
    ...
    opacity: 0.9;
    margin-top: -2px;
    /* ขยับคำว่า Monday ขึ้นมานิดนึงให้ชิดกับเลข */
}
